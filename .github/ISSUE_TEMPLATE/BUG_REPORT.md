---
name: Bug report
about: Create a report to help us improve node-chroma-logger
title: ''
labels: ''
assignees: ''
...
* [ ] I have searched the [issue tracker](https://github.com/elysiumphase/node-chroma-logger/issues) for an issue that matches the one I want to file, without success.
...
* **Node Version**:
* **NPM Version**:
* **node-chroma-logger Version**:
* **Last Known Working node-chroma-logger Version**:
